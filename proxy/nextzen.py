...
@request_map("/nextzen/{x}/{y}/{z}", method="GET")
def nextzen_ctroller_function(x=PathValue("x"),y=PathValue("y"),z=PathValue("z"),res=Response()):
    file = '/cache/nextzen/'+x+"_"+y+"_"+z+".png"
    headers={}
    ...
    content = read_url(file, headers, "https://tile.nextzen.org/tilezen/terrain/v1/256/terrarium/"+z+"/"+x+"/"+y+".png?api_key=L_qvqhVnQDW4VYQuPeILmA&")
